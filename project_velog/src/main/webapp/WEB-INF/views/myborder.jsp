			...
			<div class="hd_wrap">
				<div class="hd_logo border_hd_logo">
					<a href="/" class="border_logo_img"><img class="border_hd_icon"
						src="/img/black_favicon.png" alt=""></a> <a href="#"
						class="hd_logo_a"><span class="border_logo_txt">${borderList[0].username}.log</span></a>
				</div>
				<div class="hd_btns">
						...
						<c:otherwise>
							...
							<div class="user_nav_wrap">
								<button class="user_btn" type="button">
									<img
										src="/image/profile/${(empty principal.user.profile_img_url) ? ('user_icon.png') : (principal.user.id += '/' += principal.user.profile_img_url)}"
										alt=""> <i class="fas fa-caret-down"></i>
								</button>
								<div class="user_nav">
									<ul>
										<li class="my_page"><a
											href="/border/myborder/${principal.user.username}">내 벨로그</a></li>
										<li class="setting"><a
											href="/mypage/${principal.user.id}">설정</a></li>
			...
			<div class="bl_wrap">
				<div class="border_search_box">
					<div class="border_search">
						<i class="fas fa-search search_icon"></i> <input type="text"
							class="border_ip" placeholder="검색어를 입력하세요" autofocus>
					</div>
				</div>
				<c:forEach var="border_list" items="${borderList }">
					<div class="border_list">
						<a href="/border/${border_list.username }/${border_list.url }"
							...
							height="180px"></a> <a
							href="/border/${border_list.username }/${border_list.url }"
							class="to_detail">
