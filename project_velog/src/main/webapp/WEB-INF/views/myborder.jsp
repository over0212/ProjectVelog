            ...
            <body>
                        ...
                        <div class="hd_wrap">
                            <div class="hd_logo border_hd_logo">
                                <a href="/" class="border_logo_img"><img class="border_hd_icon"
                                        src="/img/black_favicon.png" alt=""></a>
                                <a href="#" class="hd_logo_a"><span
                            ...
                            <div class="hd_btns">
                                ...
                                <div class="user_nav_wrap">
                                    ...
                                    <div class="user_nav">
                                        <ul>
                                            <li class="my_page"><a href="/border/myborder/${principal.user.username}">내
                                                    벨로그</a></li>
                ...
                <div class="bl_container">
                    <div class="bl_info_wrap">
                        <div class="img_wrap"><img class="user_img"
