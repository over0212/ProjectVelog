	...
	<main id="main">
		<div id="dtl_container">
			...
			<section id="dtl_head">
				...
				<div class="dtl_nav">
					<div class="dtl_info">
						<a href="/border/${border.username }">${border.username }</a> <span
							class="dtl_point">·</span> <span class="dtl_date">${border.create_date }</span>
					</div>
					<div class="dtl_btn">
			...
			<!-- 하단 프로필 부분 -->
			<section id="footer">
				<a href="/border/${border.username }"><img
					src="/image/profile/${(empty border.profile_img_url) ? ('user_icon.png') : (border.id += '/' += border.profile_img_url)}"
