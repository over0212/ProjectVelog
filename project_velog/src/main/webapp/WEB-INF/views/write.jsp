		...
		<div class="write_wrap">
			<section class="write_left">
				<form class="write_form" action="" method="post">
					<div class="write_ip">
						<textarea class="write_title" name="" id=""
							placeholder="제목을 입력하세요" cols="42"></textarea>
						<div class="seperate"></div>
						<div class="write_tag">
							<span class="tag_wrap"></span> <input class="ip_tags" type="text"
								placeholder="태그를 입력하세요">
							<div class="tag_msg">
								쉼표 혹은 엔터를 입력하여 태그를 등록할 수 있습니다.<br>등록된 태그를 클릭하면 삭제됩니다.
							</div>
						</div>
					</div>
					<div class="deco_bar">
					...
					<div class="text_box">
						<textarea class="write_txt" placeholder="당신의 이야기를 적어보세요..."></textarea>
					</div>
								...
								<div class="left_wrap">
									...
									<div class="preview_contents">
										...
										<div class="input_box">
											...
											<textarea class="post_content" type="text" cols="22" placeholder="당신의 포스트를 짧게 소개해보세요."></textarea>
								...
								<div class="right_wrap">
									<div class="settings_wrap">
										...
										<div class="settings">
											...
											<button type="button" class="append_serise">
												<i class="fas fa-plus"></i>시리즈에 추가하기
											</button>
										</div>
									</div>
									<div class="submit_btns">
										...
										<button type="button" class="select_btn"
											style="display: none;">선택하기</button>
