                            ...
                            <div class="title_box_hidden">
                                ...
                                <div class="social_box_block">
                                    <div class="social_box">
                                        <div class="social_icon"><div class="social"><i class="fas fa-envelope"></i></div><span></span></div>
                                        <div class="social_icon"><div class="social"><i class="fab fa-github"></i></div><span></span></div>
                                        <div class="social_icon"><div class="social"><i class="fab fa-twitter"></i></div><span></span></div>
                                        <div class="social_icon"><div class="social"><i class="fab fa-facebook-square"></i></div><span></span></div>
                                        <div class="social_icon"><div class="social"><i class="fas fa-home"></i></div><span></span></div>
                                    </div>
